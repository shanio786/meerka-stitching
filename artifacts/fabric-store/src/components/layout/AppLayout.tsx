            ...
            {group.items.map((link) => {
              ...
              return (
                <Link key={link.href} href={link.href}>
                  ...
                  >
                    <link.icon className={`h-4 w-4 ${isActive ? "text-sidebar-primary-foreground" : "text-sidebar-foreground/70"}`} />
                    {link.name}
                  </div>
                </Link>
              );
      ...
      <aside className="hidden md:flex flex-col w-60 border-r border-sidebar-border bg-sidebar shrink-0">
        <div className="h-14 flex items-center px-5 border-b border-sidebar-border">
          <div className="flex items-center gap-2 text-primary font-bold text-lg tracking-tight">
            <div className="bg-primary text-primary-foreground w-7 h-7 flex items-center justify-center rounded-md text-xs font-bold">
              SE
            </div>
            Stitching ERP
          </div>
          ...
          <div className="flex items-center gap-4 md:hidden">
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              ...
              <SheetContent side="left" className="p-0 w-64">
                <div className="h-14 flex items-center px-5 border-b border-sidebar-border bg-sidebar">
                  <div className="flex items-center gap-2 text-primary font-bold text-lg tracking-tight">
                    <div className="bg-primary text-primary-foreground w-7 h-7 flex items-center justify-center rounded-md text-xs font-bold">
                      SE
                    </div>
